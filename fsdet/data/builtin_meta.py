...
#ADDED BELOW 
STICKERS_NOVEL_CATEGORIES = [{"id":91, "name": "car-sticker"}]

CONTIGUOUS_COCO_TINYONLY = {
  8: 0,
  10: 1,
  11: 2,
  13: 3,
...
# tiny only dataset, only 43 COCO classes
CONTIGUOUS_STICKERS_TINYONLY = {8: 0,
  10: 1,
  11: 2,
  13: 3,
  14: 4,
...
# append stickers to 60 base classes as is
CONTIGUOUS_STICKERS_BASE = {
    8: 0,
    10: 1,
    11: 2,
    13: 3,
...
CONTIGUOUS_COCO_TINYONLY_TOP4 = {10: 0, 37: 1, 38: 2, 90: 3, 91: 4}

# category ID 92 is windshield class
CONTIGUOUS_COCO_TINYONLY_TOP4_WS = {10: 0, 37: 1, 38: 2, 90: 3, 91: 4, 92: 5}
...
def _get_builtin_metadata(dataset_name):
    ...
    elif dataset_name == "stickers_fewshot":
        return _get_stickers_novel_instances_meta()
    elif dataset_name == "tinyonly_fewshot":
        return _get_tinyonly_novel_instances_meta()
    elif dataset_name == "tinyonly_top4_fewshot":
        return _get_tinyonly_top4_novel_instances_meta()
